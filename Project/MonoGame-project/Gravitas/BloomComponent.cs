...
namespace BloomPostprocess
{
    public class BloomComponent : DrawableGameComponent
    {
        ...
        protected override void LoadContent()
        {
            ...
            bloomExtractEffect = ContentLibrary.bloomExtractEffect;
            bloomCombineEffect = ContentLibrary.bloomCombineEffect;
            gaussianBlurEffect = ContentLibrary.gaussianBlurEffect;
